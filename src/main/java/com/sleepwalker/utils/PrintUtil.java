...
public class PrintUtil {
    ...
    private static String complexTypeToString(String scope, Object parentObject,
    ...
    private static void processFields(Field[] fields, String scope, Object parentObject,
                                      StringBuffer buffer,
                                      List<Object> visitedObjs) throws IllegalAccessException {
    ...
    public static boolean isCollectionType(Object obj) {
        ...
        return (obj.getClass().isArray() || (obj instanceof Collection)
                ...
                || (obj instanceof HashSet) || (obj instanceof List)
     ...
     * @return String
     */
    private static String typeToString(String scope, Object obj, List<Object> visitedObjs) {
    ...
    public static String parseToString(String scope, Object obj) {
    ...
    public static void print(String scope, Object obj) {
        ...
        System.out.println(
            "\r\n***********************" + scope + " start" + "************************\r\n");
        System.out.println(parseToString(scope, obj));
