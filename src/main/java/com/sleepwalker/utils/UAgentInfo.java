...
public class UAgentInfo {
    ...
    public boolean detectS60OssBrowser() {
        ...
        if (detectWebkit()
            && (userAgent.indexOf(deviceSymbian) != -1 || userAgent.indexOf(deviceS60) != -1)) {
            return true;
        }
        return false;
    }
    ...
    public boolean detectMaemoTablet() {
        if (userAgent.indexOf(maemo) != -1) {
            return true;
        } else if (userAgent.indexOf(linux) != -1 && userAgent.indexOf(deviceTablet) != -1
    ...
    public boolean detectSmartphone() {
        ...
        return (detectTierIphone() || detectS60OssBrowser() || detectSymbianOS()
                || detectWindowsMobile() || detectBlackBerry() || detectPalmOS());
    }
    ...
    public boolean detectTierTablet() {
        ...
        if (detectIpad() || detectAndroidTablet() || detectBlackBerryTablet()
            || detectWebOSTablet()) {
            return true;
        }
        return false;
    ...
    public boolean detectTierIphone() {
        ...
        if (detectIphoneOrIpod() || detectAndroidPhone() || detectWindowsPhone()
            || detectBlackBerry10Phone() || (detectBlackBerryWebKit() && detectBlackBerryTouch())
            || detectPalmWebOS() || detectBada() || detectTizen() || detectGamingHandheld()) {
            return true;
        }
        return false;
    }
