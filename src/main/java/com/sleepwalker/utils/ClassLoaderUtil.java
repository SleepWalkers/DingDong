...
public class ClassLoaderUtil {
    ...
    *@throwsIOException
    */
    public static InputStream getStreamByExtendResource(String relativePath) throws MalformedURLException,
                                                                             IOException {
    ...
    */
    public static URL getExtendResource(String relativePath) throws MalformedURLException {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug(
                "[Vanessa]:getExtendResource(String) - Target location: " + resourceAbsolutePath); //$NON-NLS-1$
        }
        URL resourceAbsoluteURL = new URL(resourceAbsolutePath);
        return resourceAbsoluteURL;
    }

    public static String getExtendURL(String relativePath) throws MalformedURLException {
        //ClassLoaderUtil.log.info("传入的相对路径："+relativePath) ;
        //ClassLoaderUtil.log.info(Integer.valueOf(relativePath.indexOf("../"))) ;
        if (!relativePath.contains("../")) {
    ...
    */
    public static void main(String[] args) throws MalformedURLException {
        ...
        //        try {
        //            properties.load(getStream("../Vanessa.properties"));
        //        } catch (IOException e) {
        //            // TODO Auto-generated catch block
        //            e.printStackTrace();
        //        }
        //        System.out.println(ClassLoaderUtil.getClassLoader().getResource("../Vanessa.properties")
        //            .toString());

        if (logger.isDebugEnabled()) {
            logger.debug("[Vanessa]:main(String[]) - " + getExtendURL("../../")); //$NON-NLS-1$ //$NON-NLS-2$
        }
    }
}
